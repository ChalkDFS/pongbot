...
var pong = {
        ...
        if (challenge && challenge.state == 'Proposed') {
          if (player_name == challenge.challenger[0] || (challenge.challenger[1] && player_name === challenge.challenger[1])) {
            ...
            Q.when(challenge.save(), function (challenge) {
              deferred.resolve({ message: player_name + ' accepted ' + challenge.challenger.join(' and ') + "'s challenge. TANGANAAAA!!!!", challenge: challenge });
            });
          }
            ...
            Q.when(challenge.save(), function (challenge) {
              Player.update({ currentChallenge: challenge._id }, { currentChallenge: null }, { multi: true }).then(function () {
                if (challenge.challenger[1] && player_name === challenge.challenger[1]) {
                  deferred.resolve({ message: player_name + ' declined ' + challenge.challenger[0] + "'s challenge against " + challenge.challenged.join(' and ') + '. Arrugó, pues.', challenge: challenge });
                } else {
                  deferred.resolve({ message: player_name + ' declined ' + challenge.challenger.join(' and ') + "'s challenge. Está cagao...", challenge: challenge });
                }
              });
            });
          }
  ...
  getDuelGif: function (cb) {
    var gifs = [
      ...
      'https://media.giphy.com/media/RpqA34wcqMFA4/giphy.gif',
      ...
      'https://media4.giphy.com/media/kcpobK0upw5gY/200.gif',
      'https://media3.giphy.com/media/2jmnf6gznuL8Q/200.gif',
      'https://media.giphy.com/media/LXnHb5oXtxlMA/giphy.gif',
      'https://media.giphy.com/media/HzodrF26Zn2Ug/giphy.gif',
