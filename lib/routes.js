...
module.exports.index = function (req, res) {
  ...
  if (hook) {
    ...
    case 'decline':
      ...
      break;
    case 'marico':
      res.json({ text: 'CÓMO ME DIJISTE?! CÓMO?! Te voy a matar mamaguevo.' });
      break;
    case 'chicken':
      if (params.length != 2) {
    ...
    case 'help':
      ...
      break;
    case 'father':
      res.json({ text: 'My father is the great Cristian. My creator. My master.' });
      break;
    case 'hug':
      res.json({ text: 'No.' });
      break;
    ...
    case 'thanks':
      res.json({ text: 'You\'re welcome, commander.' });
      break;
